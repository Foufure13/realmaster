...
if(isset($_POST['Envoie_avatar'])){
    if (isset($_SESSION['skin_avatar'])) {
        ...
        $insertUser = $bdd->prepare('INSERT INTO avatar(pseudo, classe, image_base64)VALUES(?, ?, ?)');
        $insertUser->execute(array($_SESSION['pseudo'], $_SESSION['classe_avatar'], $_SESSION['skin_avatar']));
